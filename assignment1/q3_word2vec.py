...
def negSamplingCostAndGradient(predicted, target, outputVectors, dataset,
    ...
    for k in xrange(K):
        ...
        t = sigmoid(outputVectors[idx].dot(predicted))
        grad[idx] += t * predicted
        gradPred += t * outputVectors[idx]
        cost -= np.log(1.0 - t)
    ### END YOUR CODE
...
def skipgram(currentWord, C, contextWords, tokens, inputVectors, outputVectors,
    ...
    for i in contextWords:
        contextCost, contextGradIn, contextGradOut = word2vecCostAndGradient(inputVectors[tokens[currentWord]], tokens[i], outputVectors, dataset)
        cost += contextCost
        gradIn[tokens[currentWord]] += contextGradIn
        gradOut += contextGradOut
    ### END YOUR CODE
